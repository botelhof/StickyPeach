...
export default class CollectionRecipeMaterialNewScreen extends React.Component {
    static navigationOptions = ({ navigation }) => {
        return {
          title: "New Recipe Material",
          headerStyle: {
                    ...
                    <Button 
                        ...
                        onPress={() => {
                            ...
                            if (!this.state.description) {
                                msg += "Please, fill the 'Material description' field. "
                            }
                            ...
                            if (msg != "") {
                                ...
                                DropDownHolder.getDropDown().alertWithType('success', 'Success', 'Recipe material created with success')
                            }
                        }}
                    />
                </View>
